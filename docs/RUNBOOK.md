...
- `pnpm test` — all unit tests, 2707 of them across 79 files (Vitest; jsdom for `src/`, node for `tooling/`) (verified)
...
- `pnpm test:e2e` — builds with the title `Floor E2E`, starts its own preview server on port 4174, runs Playwright on Chromium, one worker: 22 tests across 7 files (verified: 22 passed in 4.1 min)
