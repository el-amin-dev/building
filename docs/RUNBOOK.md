...
- `DEV_SERVER_PORT=5199 pnpm dev`, open http://localhost:5199 (5173 is taken on this machine) — walk the **whole floor** (22.50 × 10.00 m, ADR-008):
  ...
  - the interior opens on the stair arrival landing (5.10, 5.00) facing the corridor, never in a corner, and `V` there shows the **whole** person from behind, not a close-up of the head (ADR-008, ADR-013)
