 ...
 *
 * The HUD is one top-left stack — status and toggles, the room menu, the navigation hint,
 * the room readout, the minimap, then the pad of the current view — and the DOM order is
 * the Tab order: the view region comes first (inside `BuildingScene`, before this overlay),
 * then the view toggle, the camera toggle, "Go to room", and the pad buttons. The readout
 ...
 * interior, and the orbit pad renders nothing outside the exterior.
 *
 ...
 * panels shrink, the hint drops to a single line, the minimap is hidden (everything it shows is
 * also said by the readout and offered by the room menu) and the pad takes itself out of this
 * flow and anchors to the bottom of the screen, within thumb reach and clear of the band above.
