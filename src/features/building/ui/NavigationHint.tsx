...
const NAVIGATION_HINT_TEXT = 'Move: W A S D · Look: I J K L';
 ...
 * and down. Rendered only in the interior view. The panel holds two texts:
 *
 ...
 *   It spells out which key moves, turns or looks, notes that the keys follow their
 *   QWERTY positions, and says how to reach the view toggle.
 *
